...
$bodyServer = [pscustomobject]@{
  ...
  env     = [pscustomobject]@{
    ...
    BODYMESH_ENGINE_SKELETON_DIR = "C:/Users/hgner/hakantest/proje8/scripts/blender"
    BODYMESH_CHARACTER_BAKE_EXE  = "C:/Users/hgner/hakantest/proje7-engine/build/windows-msvc-static-md-release/character_bake_cli.exe"
