...
[`docs/BODY-MESH-MCP.md`](https://github.com/hgner/dsp-geometry-engine/blob/main/docs/BODY-MESH-MCP.md).
...
`'{"frames": "..."}'` verbatim.) See [`docs/COMPARISON-GATE.md`](https://github.com/hgner/dsp-geometry-engine/blob/main/docs/COMPARISON-GATE.md) for what the
...
See [`LICENSE`](https://github.com/hgner/dsp-geometry-engine/blob/main/LICENSE),
[`NOTICE`](https://github.com/hgner/dsp-geometry-engine/blob/main/NOTICE), and
[`LICENSES/README.md`](https://github.com/hgner/dsp-geometry-engine/blob/main/LICENSES/README.md) for the
